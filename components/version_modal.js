...
function Version_Model(props) {
    ...
    return (
        <>
            <div onClick={handleOpen} className='border border-[#E1E1E1] w-1/2 flex justify-between cursor-pointer'>
                ...
                <DialogTitle>
                    <div className="flex justify-between">
                        <div className='flex space-x-4'>
                            ...
                            <p className='font-semibold text-[18px] text-[#484848] mt-8'>{props.brand} {props.model} Versions</p>
                        </div>
                ...
                <DialogContent>
                    ...
                    <div>
                        <div className='flex justify-between mt-4 px-4 py-2 border-b-[1px] border-[#C6C6C6]'>
                            <p className='font-semibold text-[#484848]'>Versions</p>
