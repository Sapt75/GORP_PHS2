        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-y-10 border border-[#E1E1E1] py-12'>
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-5-lakh">
            ...
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-10-lakh">
            ...
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-15-lakh"> 
            ...
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-20-lakh">
            ...
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-25-lakh">
            ...
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-30-lakh">
            ...
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-35-lakh">
            ...
            <div className='text-center'>
                <div className={`border-[1px] border-[#6C6C6C] w-2/3 rounded-md mx-auto ${style["price-hover"]} cursor-pointer`}>
                    <Link href="/new-car-price/price-upto-40-lakh">
