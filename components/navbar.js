        ...
        <>
                ...
                <div className='sm:hidden w-full bg-white py-3'>
                    <div>
                        <div className='flex justify-evenly'>
                            <div onClick={() => document.getElementById("side").classList.add(style.scroll)}>
                                <Image className='mt-2' width={25} src={square} alt="" />
                            </div>
                            <div>
                            ...
                            <div className='flex space-x-4'>
                                <Search />
                                <Image width={20} src={notification} alt="notification" />
                            </div>
                        </div>
                    </div>
                    <div id='side' className={`h-screen min-h-screen fixed z-[999999] top-0 bg-white w-8/12 ${style.scroller}`}>
                        <div className='my-4 flex justify-between mr-4'>
                            <Image width={150} height={60} src="/images/logo.png" alt="" />
                            <Image onClick={() => document.getElementById("side").classList.remove(style.scroll)} src={cross} alt="" />
                        </div>
            ...
            <div className='hidden md:block pt-[0.5rem] pb-[0.5rem]'>
                <div className='flex justify-evenly 2xl:mx-2'>
                    <div>
                        <Image width={345} height={60} src={logo} alt="" />
                    </div>
                    ...
                    <div className='flex space-x-[1rem] 2xl:space-x-[2rem] 2xl:ml-[2rem] py-[0.8rem]'>
                        <Search status={true} />
                        <Image width={25} src={notification} alt="notification" />
                        <City status={true} />
                    </div>
                </div>
            ...
            <div className='flex md:hidden w-full space-x-0.5 fixed z-[999] bottom-0'>
                <button className='bg-[#333333] text-white text-[12px] py-2 w-1/2'><span><Image className='inline mr-2' src={book} /></span> Contact Details</button>
                <button className='bg-[#BA1223] text-white text-[12px] py-2 w-1/2'><span><Image className='inline mr-2' src={percent} /></span> Get Offers</button>
            </div>
        </>
