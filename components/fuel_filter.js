...
const Fuel_Filter = () => {
    return (
        <div className='grid grid-cols-2 md:grid-cols-4 gap-y-10 border border-[#E1E1E1] py-12'>
            <Link title='Petrol Cars' href={`/cars/fuel-type/petrol-cars`}>
            ...
            <Link title='Diesel Cars' href={`/cars/fuel-type/diesel-cars`}>
            <div className='text-center'>
            ...
            <Link title='CNG Cars' href={`/cars/fuel-type/cng-cars`}>
            <div className='text-center'>
            ...
            <Link title='Electric Cars' href={`/cars/fuel-type/electric-cars`}>
            <div className='text-center'>
