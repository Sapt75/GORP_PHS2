...
function Modal(props) {
    ...
    return (
        <>
            {props.status ? <Image onClick={handleOpen} className="cursor-pointer" width={25} src={location} alt="" /> : <div onClick={handleOpen} className='border border-[#E1E1E1] w-1/2 flex justify-between cursor-pointer'>
