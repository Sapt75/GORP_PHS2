...
`} />
            ...
            {width > 800 ? <Filter_Web host_url={host_url} data={newData} pricedata={pricedata} query={query} head={head} bres={bres} /> : <Filter_Mobile host_url={host_url} data={newData} pricedata={pricedata} query={query} head={head} bres={bres} />}
